...
// Таймеры для звука
#define time_vol_GM 27000     // Было 27000
#define time_vol_GN 50000     // Было 50000

// Таймеры для света
#define time_strip_GM 2000    // Было 2000
#define time_strip_GN 9000    // Было 9000
...
void Bloup() {                    // Обработчик Блютуза
  ...
  switch (in_telephone) {
    ...
    case 58: {
      ...
      //    case 58: {
      //#ifdef debug_bluet
      //        BluethousSerial.println("Verstein RGB");
      //#endif debug_bluet
      //        Swet_up();
      //        break;
      //      }
      ...
      //#ifdef debug_bluet
      //        BluethousSerial.print("Bri down: ");
      //        BluethousSerial.println(flag_bri_down);
      //#endif debug_bluet
      //        break;
      //      }
      //    case 60: {
      ...
      //#ifdef debug_bluet
      //        BluethousSerial.print("Bri up: ");
      //        BluethousSerial.println(flag_bri_up);
      //#endif debug_bluet
      //        break;
  }
}
